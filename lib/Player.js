...
class Player extends Entity
{
    constructor(engine, team_id, color)
    {
        ...
        super(player_svg, new Rect(0, 0, 50, 50), "Player");
        ...
        this.left_gun_pose = new Pose(-20, -20, .01);
        this.right_gun_pose = new Pose(20, -20, -.01);
    ...
    fire()
    {
        if (Date.now() - this.last_fired > this.fire_rate)
        {
            ...
            let bullet_left = new Bullet(this.left_gun_pose.after(this.pose), this);
            let bullet_right = new Bullet(this.right_gun_pose.after(this.pose), this);
