...
class Player extends PhysicsEntity
{
    constructor(engine, team_id, color)
    {
        ...
        super(`player_${color}.png`, hitbox, team_id +"-Player1");
    ...
    fire()
    {
        if (Date.now() - this.last_fired > this.fire_rate)
        {
            ...
            let bullet = new Bullet(this.gun_pose.after(this._pose), this, "Bullet");
    ...
    {   
        ...
        let explosion = new Entity("explosion-sprite.png");
        explosion.set_position(this._pose.x, this._pose.y);
        this.engine.add_entity(explosion);
        
        setTimeout(() => {
            this.engine.remove_entity(explosion);
        }, 1000);
