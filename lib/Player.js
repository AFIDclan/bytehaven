...
const { Entity, Pose, Vec2, PhysicsEntity, Image } = require('../engine');
...
class Player extends PhysicsEntity
{
    ...
    {
        super(new Image(`player_${color}.png`), Rect.from_coordinates(0, 0, 50, 50), team_id +"-Player1");
    ...
    activate_shield()
    {
        ...
        this.image = new Image("player_shield.png");
        this.shield_up = true;
    }
